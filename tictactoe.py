...
# to create the Tic-Tac-Toe game structure and GUI implementation in this file.
...
class TicTacToe:
    ...
    def setup_ui(self):
        ...
        for i in range(3):
            row = []
            for j in range(3):
                button = tk.Button(board_frame, text="", font=("Arial", 20), 
                                 width=4, height=2,
        ...
        reset_btn = tk.Button(control_frame, text="New Game", 
                             command=self.reset_game, bg="lightgreen")
